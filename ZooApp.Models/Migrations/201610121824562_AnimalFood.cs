    ...
    public partial class AnimalFood : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .Index(t => t.Name, name: "Animal_Name");
            ...
            CreateIndex("dbo.Animals", "Name", name: "Animal_Name");
            CreateIndex("dbo.Animals", "Origin", name: "Animal_Origin");
        }
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Foods", "Animal_Name");
            DropIndex("dbo.AnimalFoods", new[] { "FoodId" });
            DropIndex("dbo.AnimalFoods", new[] { "AnimalId" });
            DropIndex("dbo.Animals", "Animal_Origin");
            DropIndex("dbo.Animals", "Animal_Name");
